...
SELECT GREATEST(CHARACTER_LENGTH("PIKACHU"), CHARACTER_LENGTH("THANOS"), CHARACTER_LENGTH("ATHENA"), CHARACTER_LENGTH( "ALTHEA"), CHARACTER_LENGTH( "KRONOS"), CHARACTER_LENGTH( "THESEUS"), CHARACTER_LENGTH( "ANDROMEDA"));
...
SELECT LPAD(surname, 20, " ") FROM plang.author;
